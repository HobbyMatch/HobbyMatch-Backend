...
//        given(userRepository.findByEmail(email)).willReturn(Optional.of(user))
//        Assertions.assertEquals(userService.createUser(email, firstName, lastName), user)
//        verify(userRepository).findByEmail(email)
//    }
//
//    @Test
...
//        Assertions.assertEquals(newUser, userService.createUser(email, firstName, lastName))
//        verify(userRepository).findByEmail(email)
